...
export default function LandingPage() {
  ...
  <Link
    href="/auth/login"
    className="text-sm font-medium text-muted-foreground dark:text-white/70 hover:text-primary dark:hover:text-white transition-colors hidden sm:block"
  >
    Log in
  </Link>
  ...
  <Button
    asChild
    className="bg-primary text-primary-foreground dark:bg-white dark:text-black hover:opacity-90 rounded-full px-8 py-6 text-sm font-semibold transition-transform hover:scale-105 shadow-lg shadow-blue-500/10"
  >
...
<section className="relative pt-32 pb-24 md:pt-48 md:pb-40 px-6 overflow-hidden">
  ...
  {/* CONTENT */}
  <div className="container mx-auto max-w-7xl relative z-30 flex flex-col lg:flex-row items-center gap-20 lg:gap-24 text-center lg:text-left">
      ...
      <section className="py-16 border-y border-zinc-200 dark:border-white/5 bg-zinc-50/50 dark:bg-white/[0.01] backdrop-blur-sm">
        <div className="container mx-auto px-6">
          <p className="text-center text-sm font-bold text-zinc-400 light:text-skyblue mb-10 uppercase tracking-[0.2em]">Powering global trade for</p>
