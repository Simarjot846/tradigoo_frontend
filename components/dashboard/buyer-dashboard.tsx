...
const ProductGridItem = memo(function ProductGridItem({
  ...
  return (
    <motion.div
      ...
      onClick={() => router.push(`/product/${product.id}`)}
    >
      <div className="group rounded-2xl bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-white/5 overflow-hidden hover:border-zinc-300 dark:hover:border-white/10 hover:shadow-lg transition-all cursor-pointer h-full flex flex-col">
        
        {/* Image */}
        <div className="h-48 bg-zinc-100 dark:bg-zinc-800 relative">
          <div className="absolute top-2 right-2 bg-white/70 dark:bg-black/50 text-zinc-900 dark:text-white text-xs px-2 py-1 rounded backdrop-blur-md font-medium z-10">
            Min: {product.minimumOrderQty} units
          </div>
        ...
        <div className="p-4 flex-1 flex flex-col">
          <div className="flex justify-between items-start mb-1">
            <h3 className="font-semibold text-zinc-900 dark:text-white truncate max-w-[150px]">
              {product.name}
            </h3>
          ...
          <div className="mt-auto flex gap-2">
            <Button
              ...
              onClick={(e) => {
                e.stopPropagation();
                addToCart(product.id, product.minimumOrderQty);
              }}
            >
              Add to Cart
            </Button>
  ...
  return (
    ...
    >
      <div className="group h-full flex flex-col rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 overflow-hidden hover:border-blue-500/30 hover:shadow-lg transition-all cursor-pointer relative shadow-sm dark:shadow-none">
        ...
        {/* Image */}
        <div className="h-48 relative overflow-hidden bg-zinc-100 dark:bg-zinc-950">
          <div className="absolute inset-0 flex items-center justify-center bg-zinc-50 dark:bg-zinc-800/50">
            {product.imageUrl ? (
              <Image
                src={product.imageUrl}
                alt={product.name}
        ...
        <div className="p-6 flex flex-col flex-1">
          ...
          <Button
            ...
            className="w-full bg-zinc-900 dark:bg-white text-white dark:text-black hover:scale-[1.02] transition-all font-semibold rounded-xl"
          >
            Add to Cart
          </Button>
        </div>
